#!/bin/bash
# =============================================================================
# WhisperX-RunPod Interactive Setup Script
# =============================================================================
#
...
#
# CONFIGURATION:
#   Creates .env file in project root with all settings
#
# Usage: ./scripts/000-questions.sh
#
# =============================================================================
...
main() {
    print_header "WhisperX-RunPod Setup v$SCRIPT_VERSION"

    echo "This script will configure your WhisperX deployment for RunPod Serverless."
    ...
    DEPLOYMENT_ID="whisperx-runpod-$(date +%Y%m%d-%H%M%S)"
...
# =============================================================================
# WhisperX RunPod Serverless Deployment Configuration
# Generated by: scripts/000-questions.sh
...
RUNPOD_ENDPOINT_ID=TO_BE_DISCOVERED
...
EOF
    ...
    echo ""
    echo "Next steps:"
    echo "  1. ./scripts/200-build-image.sh     # Build Docker image"
    echo "  2. ./scripts/205-push-to-registry.sh    # Push to Docker Hub"
    echo "  3. ./scripts/210-create-endpoint.sh     # Create RunPod endpoint"
    echo "  4. ./scripts/215-test-endpoint.sh       # Test the endpoint"
    echo ""
}
